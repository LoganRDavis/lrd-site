...
- **Pages**: `index.html` (home), `background.html` (work/education history), `portfolio.html` (project showcase), `privacy.html` + `terms.html` (site-wide legal pages; `noindex`, kept out of the sitemap), `404.html`
